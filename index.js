  ...
  <script>
    const TRANSLATIONS = {
      ...
      it: { 
        ...
        feedAddress: 'Indirizzo JSON Feed Ufficiale', copy: 'Kopieren', footer: 'Tutti i diritti riservati © 2026 FlexiDrive Global OS.',
...
app.listen(PORT, () => {
  console.log(`FlexiDrive Tedarikçi Portalı Düzeltilmiş Sürüm http://localhost:${PORT} adresinde aktif!`);
});
